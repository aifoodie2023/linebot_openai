...
#-------------------------料理生成----------------------------------------------#
        ...
        reply = [
                ...
                generateRecipe(globals.habitCombine+'幫我依據飲食習慣生成一個'+ globals.cuisineType +globals.mealType +'食譜(用繁體中文)')
        ]
#-------------------------隨機生成----------------------------------------------#
    elif msg == '隨機生成' :
        reply = [
            ...
            generateRecipe(globals.habitCombine+'，'+'幫我依據飲食習慣隨機生成一個食譜(用繁體中文)')
        ]
#-------------------------輸入食材---------------------------------------------#
         ...
         reply = [
                ...
                generateRecipe(globals.ingredients+'，'+globals.habitCombine+'，請幫我依據飲食習慣生成相關的食譜')
         ]
#-------------------------節慶食譜----------------------------------------------#
    elif msg == '節慶食譜':
        reply = [
               TextSendMessage(
                ...
                generateRecipe(globals.habitCombine+'，'+'請幫我依據飲食習慣生成聖誕節的食譜')
        ]
#-------------------------食材管理----------------------------------------------#
    elif msg == '食材管理':
